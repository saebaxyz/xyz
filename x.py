...
def main():
  ...
  try:
	...
	print G+'[3] > Ambil Daftar Email Semua Teman'
	print G+'[4] help'
	print G+'[5] Intip Token'
	print G+'[6] Layar Lebar anti Ruwet'
	print G+'[7] EXIT'
...
'''
		...
		show_program()
		main()
	elif cek.lower() in ['exit','7'] :
		print "[!] Exiting Program"
		sys.exit()
	elif cek.lower() in ['help','4'] :
		info_ga()
		main()
